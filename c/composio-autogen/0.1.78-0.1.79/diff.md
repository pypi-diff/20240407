# Comparing `tmp/composio_autogen-0.1.78.tar.gz` & `tmp/composio_autogen-0.1.79.tar.gz`
...
## Comparing `composio_autogen-0.1.78.tar` & `composio_autogen-0.1.79.tar`
...
### Comparing `composio_autogen-0.1.78/PKG-INFO` & `composio_autogen-0.1.79/PKG-INFO`
...
### Comparing `composio_autogen-0.1.78/README.md` & `composio_autogen-0.1.79/README.md`

 * *Files identical despite different names*

### Comparing `composio_autogen-0.1.78/composio_autogen/autogen_toolspec.py` & `composio_autogen-0.1.79/composio_autogen/autogen_toolspec.py`

 * *Files identical despite different names*

### Comparing `composio_autogen-0.1.78/composio_autogen.egg-info/PKG-INFO` & `composio_autogen-0.1.79/composio_autogen.egg-info/PKG-INFO`
...
### Comparing `composio_autogen-0.1.78/setup.py` & `composio_autogen-0.1.79/setup.py`
