# Comparing `tmp/smaht_submitr-0.7.0.2b8.tar.gz` & `tmp/smaht_submitr-0.7.0.2b9.tar.gz`
...
### Comparing `smaht_submitr-0.7.0.2b8/pyproject.toml` & `smaht_submitr-0.7.0.2b9/pyproject.toml`
