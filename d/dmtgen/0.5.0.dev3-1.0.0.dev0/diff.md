# Comparing `tmp/dmtgen-0.5.0.dev3.tar.gz` & `tmp/dmtgen-1.0.0.dev0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dmtgen-0.5.0.dev3.tar", last modified: Sun Apr  7 09:08:22 2024, max compression
+gzip compressed data, was "dmtgen-1.0.0.dev0.tar", last modified: Wed Oct 19 05:29:46 2022, max compression
```

## Comparing `dmtgen-0.5.0.dev3.tar` & `dmtgen-1.0.0.dev0.tar`

### file list

```diff
@@ -1,36 +1,32 @@
-drwxrwxrwx   0        0        0        0 2024-04-07 09:08:22.239230 dmtgen-0.5.0.dev3/
--rw-rw-rw-   0        0        0     1093 2024-03-15 06:07:02.000000 dmtgen-0.5.0.dev3/LICENSE
--rw-rw-rw-   0        0        0      499 2024-04-07 09:08:22.225085 dmtgen-0.5.0.dev3/PKG-INFO
--rw-rw-rw-   0        0        0      105 2024-03-15 06:07:02.000000 dmtgen-0.5.0.dev3/README.md
--rw-rw-rw-   0        0        0       42 2024-04-07 09:08:22.239230 dmtgen-0.5.0.dev3/setup.cfg
--rw-rw-rw-   0        0        0     1122 2024-04-07 08:43:46.000000 dmtgen-0.5.0.dev3/setup.py
-drwxrwxrwx   0        0        0        0 2024-04-07 09:08:22.073518 dmtgen-0.5.0.dev3/src/
-drwxrwxrwx   0        0        0        0 2024-04-07 09:08:22.130868 dmtgen-0.5.0.dev3/src/dmtgen/
--rw-rw-rw-   0        0        0      330 2024-03-15 06:54:16.000000 dmtgen-0.5.0.dev3/src/dmtgen/__init__.py
--rw-rw-rw-   0        0        0     3694 2024-04-07 07:59:16.000000 dmtgen-0.5.0.dev3/src/dmtgen/base_generator.py
--rw-rw-rw-   0        0        0     1689 2024-03-15 06:07:02.000000 dmtgen-0.5.0.dev3/src/dmtgen/basic_template_generator.py
-drwxrwxrwx   0        0        0        0 2024-04-07 09:08:22.195995 dmtgen-0.5.0.dev3/src/dmtgen/common/
--rw-rw-rw-   0        0        0        0 2024-03-15 06:07:02.000000 dmtgen-0.5.0.dev3/src/dmtgen/common/__init__.py
--rw-rw-rw-   0        0        0     2657 2024-04-07 08:13:22.000000 dmtgen-0.5.0.dev3/src/dmtgen/common/blueprint.py
--rw-rw-rw-   0        0        0     3725 2024-04-07 09:02:20.000000 dmtgen-0.5.0.dev3/src/dmtgen/common/blueprint_attribute.py
--rw-rw-rw-   0        0        0     1128 2024-03-15 06:54:16.000000 dmtgen-0.5.0.dev3/src/dmtgen/common/enum_description.py
--rw-rw-rw-   0        0        0     7759 2024-04-07 08:08:34.000000 dmtgen-0.5.0.dev3/src/dmtgen/common/package.py
--rw-rw-rw-   0        0        0      254 2024-03-15 06:54:16.000000 dmtgen-0.5.0.dev3/src/dmtgen/common/system_package.py
-drwxrwxrwx   0        0        0        0 2024-04-07 09:08:22.072514 dmtgen-0.5.0.dev3/src/dmtgen/data/
-drwxrwxrwx   0        0        0        0 2024-04-07 09:08:22.072514 dmtgen-0.5.0.dev3/src/dmtgen/data/system/
-drwxrwxrwx   0        0        0        0 2024-04-07 09:08:22.205000 dmtgen-0.5.0.dev3/src/dmtgen/data/system/SIMOS/
--rw-rw-rw-   0        0        0      454 2024-04-07 08:04:42.000000 dmtgen-0.5.0.dev3/src/dmtgen/data/system/SIMOS/entity.json
--rw-rw-rw-   0        0        0      536 2024-04-07 08:04:46.000000 dmtgen-0.5.0.dev3/src/dmtgen/data/system/SIMOS/named_enity.json
--rw-rw-rw-   0        0        0      533 2024-03-15 06:54:16.000000 dmtgen-0.5.0.dev3/src/dmtgen/none_generator.py
--rw-rw-rw-   0        0        0      445 2024-03-15 06:07:02.000000 dmtgen-0.5.0.dev3/src/dmtgen/package_generator.py
--rw-rw-rw-   0        0        0      214 2024-03-15 06:54:16.000000 dmtgen-0.5.0.dev3/src/dmtgen/template.py
--rw-rw-rw-   0        0        0      722 2024-03-15 06:34:17.000000 dmtgen-0.5.0.dev3/src/dmtgen/template_generator.py
-drwxrwxrwx   0        0        0        0 2024-04-07 09:08:22.216934 dmtgen-0.5.0.dev3/src/dmtgen.egg-info/
--rw-rw-rw-   0        0        0      499 2024-04-07 09:08:21.000000 dmtgen-0.5.0.dev3/src/dmtgen.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      750 2024-04-07 09:08:22.000000 dmtgen-0.5.0.dev3/src/dmtgen.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-04-07 09:08:21.000000 dmtgen-0.5.0.dev3/src/dmtgen.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       14 2024-04-07 09:08:21.000000 dmtgen-0.5.0.dev3/src/dmtgen.egg-info/requires.txt
--rw-rw-rw-   0        0        0       13 2024-04-07 09:08:22.000000 dmtgen-0.5.0.dev3/src/dmtgen.egg-info/top_level.txt
-drwxrwxrwx   0        0        0        0 2024-04-07 09:08:22.211274 dmtgen-0.5.0.dev3/src/tests/
--rw-rw-rw-   0        0        0        0 2024-03-15 06:07:02.000000 dmtgen-0.5.0.dev3/src/tests/__init__.py
--rw-rw-rw-   0        0        0      732 2024-03-15 06:54:16.000000 dmtgen-0.5.0.dev3/src/tests/test_relative_paths.py
...
### Comparing `dmtgen-0.5.0.dev3/LICENSE` & `dmtgen-1.0.0.dev0/LICENSE`

 * *Files identical despite different names*

### Comparing `dmtgen-0.5.0.dev3/setup.py` & `dmtgen-1.0.0.dev0/setup.py`
...
### Comparing `dmtgen-0.5.0.dev3/src/dmtgen/base_generator.py` & `dmtgen-1.0.0.dev0/src/dmtgen/base_generator.py`
...
### Comparing `dmtgen-0.5.0.dev3/src/dmtgen/basic_template_generator.py` & `dmtgen-1.0.0.dev0/src/dmtgen/basic_template_generator.py`

 * *Files identical despite different names*

### Comparing `dmtgen-0.5.0.dev3/src/dmtgen/common/blueprint_attribute.py` & `dmtgen-1.0.0.dev0/src/dmtgen/common/blueprint_attribute.py`
...
### Comparing `dmtgen-0.5.0.dev3/src/dmtgen/data/system/SIMOS/named_enity.json` & `dmtgen-1.0.0.dev0/src/dmtgen/data/system/SIMOS/named_enity.json`
...
### Comparing `dmtgen-0.5.0.dev3/src/dmtgen/template_generator.py` & `dmtgen-1.0.0.dev0/src/dmtgen/template_generator.py`

 * *Files identical despite different names*

### Comparing `dmtgen-0.5.0.dev3/src/dmtgen.egg-info/SOURCES.txt` & `dmtgen-1.0.0.dev0/src/dmtgen.egg-info/SOURCES.txt`
